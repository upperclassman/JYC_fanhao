...
# 1.定义要爬取的页面
urls = ["https://javdb.com/actors/MbNR?page=2&sort_type=0&t=d%2Cs"]
for i in range(1, 2):
# 2.定义页码
    url = 'https://javdb.com/actors/MbNR?page=' + str(i)+'&sort_type=0&t=d%2Cs'
    urls.append(url)

# 定义csv文件的表头
csv_file = open('nai.csv', 'w', newline='', encoding='utf-8')
